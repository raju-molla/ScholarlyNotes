...
export default function DraftEditor({ draftId, initial }) {
  ...
  stateRef.current = { title, subtitle, project, tagsInput, citationStyle, citations, sections, targets, figures };
  ...
  }, [title, subtitle, project, tagsInput, citationStyle, citations, sections, targets, figures, draftId]);
